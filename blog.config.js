...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'haning', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '資訊科', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://notion-next-pearl-six.vercel.app/', // 网站地址
  ...
  // 自定义外部脚本，外部样式
  CUSTOM_EXTERNAL_JS: ['/ar-widget.js'], // e.g. ['http://xx.com/script.js','http://xx.com/script.js']
